...
// @section info
    ...
    #define STRING_CONFIG_H_AUTHOR "(GaryMeg, Ender-3 26/08/24 07:20)" // Who made the changes.
...
// @section machine
  ...
  #define CUSTOM_MACHINE_NAME "GaryMeg Ender-3 build 24/08/24 22:23"
...
//!   //#define PID_AUTOTUNE_MENU     // Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of flash)
     ...
     * Default Settings                   { 80, 80, 400, 93 }
     * Ender 3 Mesured                    { 80, 80, 400, 143.29 } 
     * */
//!  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 93 }
    #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 144.29 }
...
//! //#define NEOPIXEL2_PIN                   // LED driving pin
      #define NEOPIXEL2_PIN              PC14 // LED driving pin
